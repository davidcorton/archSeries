...
#' @export
#' @examples
#' date.ranges <- data.table(unit=c(1, 2, 3, 4), Start=c(450, 450, 600, 1000), End=c(700, 800, 650, 1200))
#' results <- date.simulate2(date.ranges, context.fields="unit", start.date=400, end.date=1200, bin.width=200)
#' x <- RoC(results[[1]])
